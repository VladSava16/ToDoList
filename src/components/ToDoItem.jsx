  ...
  return (
    <li className='flex items-left justify-between py-3 border-b border-gray-200 last:border-b-0 hover:bg-gray-50'>
      ...
      <div className='flex items-center gap-3 pl-4'>
        <input type="checkbox" onChange={handleComplete} className='h-5 w-5 cursor-pointer hover:text-blue-700 text-blue-600 transition-colors duration-200 focus:ring-2 focus:ring-blue-500'/>
