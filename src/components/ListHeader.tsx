...
const ListHeader = ({sortOrder, handleSortOrderChange, handleFilterBy, filterByStatus}: ListHeaderProps) => {
  
  const handleOnClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    handleFilterBy(e.currentTarget.id);
  }
